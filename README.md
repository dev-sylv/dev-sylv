# 👋 Hi, I'm Chimnecherem Sylvia N. Adimike

### Director of Software | Full Stack MERN Engineer | Sui Blockchain & Move Developer | DevOps Practitioner | CTO, ecoPAY

I’m a full stack software engineer passionate about building user-centered digital products across Web2 and Web3.  
I work with JavaScript, MERN, DevOps tools, and the Sui Blockchain (Move language) to create secure, scalable, and impactful solutions.

I’m also the Technical Lead for **Sui on Campus**, where I teach, mentor, and help students build smart contracts and DeFi applications.

---

## 🚀 About Me
- 👩‍💻 Full Stack MERN Engineer  
- 🧱 Sui Blockchain & Move Smart Contract Developer  
- ⚙️ DevOps Learner (Daily Logs)  
- 🧪 Currently building **ecoPAY** (reverse vending + fintech recycling)  
- ♻️ Founder of **ecoBIN** – connecting rural communities to reliable waste collectors  
- 🛠 Technical Lead — Sui On Campus  
- 🎤 Speaker | Educator | Community Builder
- 📫 How to reach me adimikesylvia@gmail.com
...
![Move](https://img.shields.io/badge/Move-000?logo=sui&logoColor=fff)
...
## 🌐 Blockchain & Web3 (Sui Ecosystem)
- Move smart contract development  
- DeFi protocols on Sui  
- Gas optimizations and transaction design  
- Sui zkLogin & wallet integrations  
- Developer tooling + campus workshops  
...
### ✨ “Building. Teaching. Improving — one line of code at a time.”  
